        ...
        <div className="space-y-3">
          ...
          <div className="mt-4 space-y-2">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="https://www.facebook.com/share/1biekHKhDt/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:text-slate-900"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://www.instagram.com/srgv_ninat?utm_source=qr&igsh=MWM2MjFqOWE4YXlicA=="
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:text-slate-900"
              ...
              <a
                href="https://youtube.com/@shreeradhagovindvidyamandi9872?si=H1bmuPC2Y5ZRLwU9"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:text-slate-900"
                aria-label="YouTube"
